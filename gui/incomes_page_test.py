...
class IncomesPageTest(FinancialsPage):
    ...
    def show_add_income_form(self):
        ...
        self.amount_entry = CTkEntry(self.info_panel, placeholder_text="Amount")
    ...
    def edit_item(self):
        ...
        self.amount_entry.grid(row=1, column=1, pady=(50, 10), padx=10, sticky="w")
        ...
        self.from_entry.grid(row=2, column=1, pady=(20, 10), padx=10, sticky="w")
