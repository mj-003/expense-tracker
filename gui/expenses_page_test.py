...
class ExpensePageTest(FinancialsPage):
    def __init__(self, parent, app, database, user, user_expenses, user_incomes):
        super().__init__(parent=parent, app=app, database=database, user=user, user_items=user_expenses, user_items2=user_incomes)
    ...
    def edit_expense(self):
        ...
        price_entry = CTkEntry(self.edit_dialog, textvariable=StringVar(value=self.item_info[1]))
        ...
        category_entry = CTkEntry(self.edit_dialog, textvariable=StringVar(value=self.item_info[2]))
        ...
        date_entry = CTkEntry(self.edit_dialog, textvariable=StringVar(value=self.item_info[3]))
        ...
        payment_entry = CTkEntry(self.edit_dialog, textvariable=StringVar(value=self.item_info[4]))
        payment_entry.grid(row=4, column=1, pady=10, padx=10, sticky="w")

        save_button = ctk.CTkButton(self.edit_dialog, text="Save",
                                    fg_color="#2A8C55",
                                    command=lambda: self.save_item(self.edit_dialog))
